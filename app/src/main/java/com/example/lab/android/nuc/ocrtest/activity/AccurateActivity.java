...
public class AccurateActivity extends AppCompatActivity {
    ...
    private FloatingActionButton text_to_voice,voice_to_text,change_voice;
...
//        } );
        ...
        if(ContextCompat.checkSelfPermission( AccurateActivity.this, Manifest.
        ...
        if (! permissionList.isEmpty()){
            ...
            ActivityCompat.requestPermissions( AccurateActivity.this,permissions,1 );
        }else {
    ...
    private void initFloatButton(){
        ...
        change_voice.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new BottomSheet.Builder(AccurateActivity.this)
                        .title( "选择声音种类" )
    ...
    private void voice_text(){
        // 有交互动画的语音识别器
        iatDialog = new RecognizerDialog(AccurateActivity.this, mInitListener);
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            ...
            if (code != ErrorCode.SUCCESS) {
                Toast.makeText(AccurateActivity.this, "初始化失败，错误码：" + code, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void SpeechSynthesizer(String text){
        ...
        SpeechSynthesizer mTts = SpeechSynthesizer.createSynthesizer(AccurateActivity.this, null);
...
//        Toast.makeText(MainActivity.this, "语音合成 保存音频到本地：\n" + isSuccess, Toast.LENGTH_LONG).show();
        ...
        if (code != ErrorCode.SUCCESS) {
            if (code == ErrorCode.ERROR_COMPONENT_NOT_INSTALLED) {
                //上面的语音配置对象为初始化时：
                Toast.makeText(AccurateActivity.this, "语音组件未安装", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(AccurateActivity.this, "语音合成失败,错误码: " + code, Toast.LENGTH_LONG).show();
            }
        }
    }
    //合成监听器
